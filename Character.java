...
import javax.swing.ImageIcon;
 ...
 //人物hp生命值计算公式       hp = 30 + strength * 4;
 //人物MP魔法值计算公式       mp = 20 + intelligence * 3;
 //攻击力计算公式       attack = (int)(strength * 1.5);
 //防御力计算公式       defense = (int)((strength + speed) * 0.5 );    


//主角和怪兽皆继承此类
public class Character {
    
    Image image = (new ImageIcon("./util/主角.jpeg")).getImage();//人物头像
    //状态最大值
    String name;
    int level;
    int strength;
    ...
    //装备 
    int[] equip = new int[10];Equipment[] equipment = new Equipment[10];//主角的装备
    int[] equip2 = new int[5];
    Equipment[] equipment2 = new Equipment[5];//0表示武器。1表示衣服，2表示鞋，3表示装饰品1，4表示装饰品2
    
    int[] ski = new int[10];//用来表示文件中的技能号；ski[]=1表示第一个技能
    Skill[] skill = new Skill[10];//主角的技能
    ...
    public Character(String name,int level){           //初始状态
