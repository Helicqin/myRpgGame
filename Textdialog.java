...
public class Textdialog extends JDialog implements   KeyListener,MouseListener{
    ...
    public void mousePressed(MouseEvent e) {
       if(e.getButton()==1)      //Releases all of the native screen resources used by this Window2
    	   this.dispose();
    }
    ...
    public void keyPressed(KeyEvent e) {
        if(e.getKeyCode() == ' '||e.getKeyCode() == '\n')
            this.dispose();//Releases all of the native screen resources used by this Window2
    }
